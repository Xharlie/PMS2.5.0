<!doctype html>
<div class = "mode" >
    <button class="buttonUnClicked" ng-class ="buttonClicked" ng-click = "viewClickBuy()">购买商品</button>
    <button class="buttonUnClicked" ng-class ="buttonClicked" ng-click = "viewClickManage()">购买记录</button>
</div>

<div ng-switch on="viewClick" ng-init=" viewClick = 'Buy'" class="animate-switch-container">
    <div class="animate-switch fixedheight" ng-switch-when ="Buy">
        <div class="prodSearch">
            <select ng-model="prodTypeFilter" ng-change="nullify(prodTypeFilter);">
            ...
            <input type="text"  ng-change = "nullify(prodNameFilter);" ng-model = "prodNameFilter" placeholder="按产品名搜索">
            <select ng-model="prodSorter" >
        ...
        <div class="purchaseBoard">
            <input type="text"  ng-init="initRoomsInfo(prodRoom);" ng-model="prodRoom"  ng-change = "checkRoom(prodRoom)" placeholder="房间号，默认为哑房帐" />
            <label>{{room}}</label>
            <input type="submit"
                   class="buyButton"
