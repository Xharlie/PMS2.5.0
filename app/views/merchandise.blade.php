                     ...
                     <!-- <label>{{room}}</label> -->
                       ...
                       <!--             <th>总计</th> -->
                        ...
                        <div class="ctrlArea">
                            ...
                            <input class="input-sm searchBox" type="text"  ng-init="initRoomsInfo(prodRoom);" ng-model="prodRoom"  ng-change = "checkRoom(prodRoom)" placeholder="房间号，默认为哑房帐" />
                            <input type="submit"
                                   class="buyButton btn btn-primary btn-block"
