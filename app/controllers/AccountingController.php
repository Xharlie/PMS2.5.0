...
//            ->where("MemTranDeposit.HTL_ID",Session::get('userInfo.HTL_ID'))
...
//            MemTranDeposit.FILLED as FILLED,
//            CONCAT('MEM-',MemTranDeposit.MEM_DEPO_ID) as ACCT_ID,
//            MemTranDeposit.ORGN_ACCT_ID as ORGN_ACCT_ID,
//            MemTran. as RM_ID,
//            MemTranDeposit.RM_TRAN_ID as RM_TRAN_ID,
//            MemTranDeposit.RM_TRAN_ID as TKN_RM_TRAN_ID,'' as PAYER_NM,'' as PAYER_PHONE,
//            MemTranDeposit.PAY_METHOD as PAY_METHOD,
//            '' as 'CONSUME_PAY_AMNT',RoomDepositAcct.DEPO_AMNT as 'SUBMIT_PAY_AMNT',RoomDepositAcct.RMRK as RMRK,false as CON,true as PAY "));
...
//            ->whereRaw("UNIX_TIMESTAMP(PenaltyAcct.BILL_TSTMP) BETWEEN ".$twoDaysAgo." AND ".$today)
            ...
            CONCAT('PEN-',PenaltyAcct.PEN_BILL_ID) as ACCT_ID,
            PenaltyAcct.ORGN_ACCT_ID as ORGN_ACCT_ID,
            RoomTran.RM_ID as RM_ID,
...
//            ->whereRaw("UNIX_TIMESTAMP(RoomAcct.BILL_TSTMP) BETWEEN ".$twoDaysAgo." AND ".$today)
            ...
            CONCAT('BIL-',RoomAcct.RM_BILL_ID) as ACCT_ID,
            RoomAcct.ORGN_ACCT_ID as ORGN_ACCT_ID,
            RoomTran.RM_ID as RM_ID,
...
//            ->whereRaw("UNIX_TIMESTAMP(StoreTransaction.STR_TRAN_TSTMP) BETWEEN ".$twoDaysAgo." AND ".$today)
            ...
            CONCAT('STR-',StoreTransaction.STR_TRAN_ID) as ACCT_ID,
            StoreTransaction.ORGN_ACCT_ID as ORGN_ACCT_ID,
            RoomStoreTran.RM_ID as RM_ID,
